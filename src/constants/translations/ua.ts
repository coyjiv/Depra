...
export const ua = {
    translation: {
        ...
        test: {
            allQuestionAreRequired: "Всі питання обов'язкові для заповнення",
        ...
        progress: {
            ...
            totalTestsTaken: 'Всього пройдено тестів: ',
            totalMoodEntries: 'Всього записів настрою: ',
            emotions: 'Емоції',
            mostCommonEmotions: 'Найпоширеніші емоції',
            emotionCount: 'Загальна кількість',
            timeslots: {
